...
export default function PrivacyPolicy() {
  ...
  return (
    <article className="legal-page">
      ...
      <section><h2>How information is used</h2><p>We use information to operate the prompt library, authenticate approved contributors, review submissions, prevent abuse, understand consented usage, and maintain security. We do not sell personal information.</p></section>
      <section><h2>Storage and service providers</h2><p>The service uses Supabase for authentication, database, and file storage; Vercel for hosting; Upstash for rate limiting; Sentry for error monitoring; and PostHog for consented analytics.</p></section>
